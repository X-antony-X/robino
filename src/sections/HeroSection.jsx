...
import ExploreBtn from "../react bits/ExploreBtn.jsx";
...
function HeroSection() {
  ...
  return (
    <section ref={sectionRef} className="hero-section flex items-center h-[350px]">
      <div className="content flex gap-10 flex-col items-center justify-center w-1/2">
        <div className="title">
            <span className="btn"><i className="animation"></i>ROBINO<i className="animation"></i></span>
        </div >

        <div className="flex flex-col justify-center items-center gap-4">
          <p className="paragraph text-lg md:text-xl lg:text-2xl">
            Welcome to <span className="nice-font text-[#4A4A4A] text-bold">ROBINO</span>
          </p>
          <p className="paragraph text-lg md:text-xl lg:text-2xl text-center">
