        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            <motion.div
              ...
              <p className="text-lg leading-8 text-muted-foreground">
                الـ Mockup هو صورة احترافية بتوريك شكل تصميمك أو لوجو شركتك على التيشرت قبل ما نبدأ طباعة فعلياً. ده بيضمن لك إن النتيجة تطلع بالظبط زي ما رسمتها في خيالك وبأعلى دقة
              </p>
              <br />
              <p className="text-lg leading-8 text-muted-foreground">
  ...
  {mockUp.map((card, index) => (
    ...
    >
      ...
      <div className="relative mx-4 -mt-6 overflow-hidden rounded-xl shadow-lg bg-[#252525]">
        <div className="grid grid-cols-3 grid-rows-2 gap-1 h-44 sm:h-48">
          <img
            src={card.img1}
            className="col-span-2 row-span-1 w-full h-full object-cover rounded-md"
          />
          <img
            src={card.img2}
            className="col-span-2 row-span-1 w-full h-full object-cover rounded-md"
      ...
      <div className="p-6">
        ...
        <p className="text-sm font-light text-gray-400 text-right">
          حول فكرتك لواقع
          <br />
          بنطبع تصميمك الخاص على أجود خامات القطن بلمسة احترافية
          تدوم طويلاً
        </p>
      </div>
      ...
      <div className="p-6 pt-0">
        <button className="w-full rounded-lg bg-white py-3 px-6 text-xs font-bold uppercase text-black shadow-md transition-all hover:scale-105 active:opacity-[0.85]">
          اطلب تصميمك الآن
        </button>
      </div>
    </div>
