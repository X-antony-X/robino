...
function LatTopHeader() {
    return (
        <header className="w-full flex justify-between items-center bg-white shadow-md p-4 border-b-2 border-[#121212] fixed top-0 left-0 z-50">
            <div>
